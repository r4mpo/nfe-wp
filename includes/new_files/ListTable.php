	...
	public function render_order_number_column( WC_Order $order ): void {
		...
		if ( $order->get_status() === 'trash' ) {
			...
			if($order->get_status() == 'completed'){
				echo '<a href="nfe.php?id=' . base64_encode($order->get_id()) . '" target="_blank" class="order-view"><button type="button" style="color: #2271b1;" title="GERAR DOCUMENTO PARA NF-E"><span class="dashicons dashicons-printer"></span></button></a>';
			}
		}
	}
